    ...
    return (
        ...
        >
            ...
            >
                ...
                {uiVisible && (
                <div className="fixed bottom-20 xl:bottom-6 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center gap-2 w-max max-w-[95vw]">
                ...
                {/* Compact floating toolbar */}
                    <div className={"text-white backdrop-blur-md rounded-2xl sm:rounded-full px-3 py-1.5 shadow-lg max-w-full w-full "
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3">
                            ...
                            <div className="flex flex-wrap justify-center items-center gap-x-1.5 gap-y-1 sm:gap-x-3">
